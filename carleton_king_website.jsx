...
// Design Decision Log:
// 1. Single-page scroll vs multi-page: Chose single-page for cinematic flow, agents don't want to click around
// 2. Animation philosophy: Subtle, premium, cinematic - not playful or bouncy
// 3. Color: Rich black + burgundy + gold accents = sophisticated, masculine, memorable
// 4. Typography: Elegant serif for name (prestige), clean sans for body (readable)
// 5. Reel: Modal popup for immersive viewing without leaving context
// 6. Credits: Sectioned list, not cards - cleaner, more scannable, industry-standard format
// 7. Texture: Subtle noise grain for depth, not overt patterns

const CarletonKingWebsite = () => {
  ...
  const skills = {
    ...
    other: ['Drums', 'Teleprompter', 'Hosting', 'Billiards'],
  };
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-[#F5F5F5] overflow-x-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <button 
            ...
            className="text-xl tracking-wider font-light hover:text-[#CFB53B] transition-colors duration-300"
          ...
          >
            <span className={`w-6 h-px bg-white transition-all duration-300 ${mobileMenuOpen ? 'rotate-45 translate-y-2' : ''}`} />
      ...
      <section id="home" className="min-h-screen relative flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <div 
            className="w-48 h-48 md:w-64 md:h-64 mx-auto mb-8 rounded-full overflow-hidden border-2 border-[#722F37]/30 shadow-2xl"
            style={{
          ...
          >
            <div 
              className="w-full h-full bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] flex items-center justify-center"
            >
              <span className="text-[#444] text-xs tracking-widest uppercase">Headshot</span>
            </div>
          </div>
          ...
          {/* Subtitle */}
          <p 
            className="text-[#888888] text-lg md:text-xl tracking-[0.3em] uppercase mb-2"
            style={{
          ...
          {/* Status line */}
          <p 
            className="text-[#666666] text-sm tracking-widest uppercase mb-12"
            style={{
          ...
          <button
            ...
            className="group relative inline-flex items-center gap-3 px-8 py-4 bg-[#722F37] hover:bg-[#8B3D47] text-white tracking-widest uppercase text-sm transition-all duration-500 overflow-hidden"
            style={{
            ...
            <div className="space-y-0">
              {tvCredits.map((credit, i) => (
                ...
                >
                  ...
                  <div className="col-span-6 md:col-span-3 text-[#666] text-right">
                    {credit.network}
                  </div>
                </div>
              ))}
              ...
              {theaterCredits.map((credit, i) => (
                ...
                >
                  <div className="col-span-12 md:col-span-5">
                    ...
                    {credit.festival && (
                      <span className="ml-2 text-xs text-[#722F37]">({credit.festival})</span>
                    )}
                  </div>
                  <div className="col-span-6 md:col-span-4 text-[#888]">
                    Lead: {credit.role}
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid md:grid-cols-5 gap-12 items-center">
            ...
            <div className="md:col-span-3">
              ...
              <h2 
                className="text-3xl md:text-4xl tracking-wider mb-8"
                style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
              >
                The Actor
              </h2>
              ...
              <div className="space-y-4 text-[#AAAAAA] leading-relaxed">
                <p>
                  Brooklyn-born actor with nearly two decades of experience across film, television, and theater. From guest appearances on Marvel's <span className="text-[#F5F5F5]">Daredevil</span> to lead roles in independent features, Carleton brings depth, physicality, and authenticity to every role.
                </p>
                <p>
                  Known for his action capabilities and dramatic range, he is trained in multiple martial arts disciplines and performs his own stunts. His work spans drama, thriller, and action genres with equal command.
                </p>
                <p className="text-[#888]">
                  An accomplished filmmaker whose work has been selected for international festivals including Cannes Arts Fest and Amsterdam Movie Fest, he brings a director's eye for performance and story to every project.
                </p>
              </div>
              ...
              <div className="mt-10 pt-8 border-t border-white/5 grid grid-cols-3 gap-4">
                <div>
                  <p className="text-2xl md:text-3xl text-[#CFB53B]" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>20+</p>
                  <p className="text-[#666] text-xs tracking-wider uppercase mt-1">Years Experience</p>
                </div>
                <div>
                  <p className="text-2xl md:text-3xl text-[#CFB53B]" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>8+</p>
                  <p className="text-[#666] text-xs tracking-wider uppercase mt-1">Lead Film Roles</p>
                </div>
                <div>
                  <p className="text-2xl md:text-3xl text-[#CFB53B]" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>2</p>
      ...
      >
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          {/* Representation placeholder - update when signed */}
      ...
      <footer className="py-8 border-t border-white/5">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[#444] text-sm">
            © {new Date().getFullYear()} Carleton King. All rights reserved.
          </p>
          <p className="text-[#444] text-sm">
            Brooklyn, NYC • SAG-AFTRA Eligible
          </p>
        </div>
      </footer>
      ...
      {/* Global Styles */}
      <style jsx global>{`
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500&family=Playfair+Display:wght@300;400;500;600&display=swap');
...
export default CarletonKingWebsite;
